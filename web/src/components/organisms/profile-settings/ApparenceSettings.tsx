...
const ACCENT_COLORS = [
  "#2B70C9", "#1D9E75", "#D85A30",
  "#D4537E", "#BA7517", "#7F77DD", "#555555",
];

const BANNER_PRESETS = [
  { label: "Océan",   value: "linear-gradient(135deg, #2B70C9 0%, #1D9E75 100%)" },
  { label: "Coucher", value: "linear-gradient(135deg, #D85A30 0%, #BA7517 100%)" },
  { label: "Nuit",    value: "linear-gradient(135deg, #3b1f6e 0%, #2B70C9 100%)" },
  { label: "Forêt",   value: "linear-gradient(135deg, #1D9E75 0%, #3B6D11 100%)" },
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
      ...
      <div style={subCardStyle}>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <div style={{ height: 50, borderRadius: 8, background: bannerGradient }} />
        </div>
      </div>
          ...
          {BANNER_PRESETS.map(({ label, value }) => (
            <button
              ...
              style={{
                ...
                border: bannerGradient === value
                  ? "1.5px solid var(--color-text-primary)"
                  : "0.5px solid var(--color-border-secondary)",
              }}
            >
              <div style={{ width: 36, height: 20, borderRadius: 4, background: value, flexShrink: 0 }} />
      ...
      <div style={subCardStyle}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            { value: "public"  as const, label: "Public",  desc: "Visible par les recruteurs et la communauté" },
            { value: "private" as const, label: "Privé",   desc: "Uniquement toi et tes recruteurs associés" },
            { value: "hidden"  as const, label: "Masqué",  desc: "Profil non indexé" },
