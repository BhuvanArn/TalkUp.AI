...
/** Static theme color for consistent UI elements */
...
/** Preset background styles for the profile banner */
 ...
 * Features: 
 * - Stats displayed under identity for better flow.
 * - Avatar with a contextual menu for photo management.
 */
function Profile() {
  ...
  /** State for avatar menu visibility */
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 24, alignItems: "start" }}>
              ...
              <div style={settingsPanelStyle}>
                ...
                {activeTab === "notifs" && (
                  <NotifSettings notifs={[]} accentColor={THEME_ACCENT} onToggle={() => {}} />
                )}
              </div>
            </div>
...
const headerCardStyle: React.CSSProperties = {
  background: "#FFF", borderRadius: 16, border: "0.5px solid #E5E7EB", overflow: "hidden", marginBottom: 24,
};

const bannerBtnStyle: React.CSSProperties = {
  position: "absolute", bottom: 10, right: 12, padding: "4px 10px", fontSize: 11, borderRadius: 6, 
  background: "rgba(0,0,0,0.3)", color: "white", border: "none", cursor: "pointer",
};
...
const cameraBtnStyle: React.CSSProperties = {
  ...
  background: "white", borderStyle: "solid", borderWidth: 2, display: "flex", alignItems: "center", 
  justifyContent: "center", cursor: "pointer", boxShadow: "0 2px 8px rgba(0,0,0,0.12)", zIndex: 10
};

const dropdownStyle: React.CSSProperties = {
  position: "absolute", top: "110%", left: "50%", transform: "translateX(-50%)",
  background: "white", borderRadius: 10, boxShadow: "0 10px 25px rgba(0,0,0,0.1)",
  border: "1px solid #E5E7EB", padding: "6px", minWidth: "180px", zIndex: 100, display: "flex", flexDirection: "column"
};

const dropdownItemStyle: React.CSSProperties = {
  padding: "10px 12px", fontSize: 13, color: "#374151", background: "none", border: "none",
  borderRadius: 6, textAlign: "left", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px",
};

const statLabelStyle: React.CSSProperties = { 
  fontSize: 10, color: "#6B7280", textTransform: "uppercase", letterSpacing: 0.5, fontWeight: 600, marginTop: 2 
};
